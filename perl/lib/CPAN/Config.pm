...
if ( -d 'D:\\proXAMPP\\minicpan' ) {
  ...
  unless ( $@ ) {
    if ( LWP::Online::online() ) {
      push @urllist, q[file:///D:/proXAMPP/minicpan/];
    } else {
      unshift @urllist, q[file:///D:/proXAMPP/minicpan/];
    }
  }
}
...
$CPAN::Config = {
  ...
  auto_commit                   => q[1],
  build_cache                   => q[50],
  build_dir                     => q[D:\\proXAMPP\\cpan\\build],
  build_dir_reuse               => q[0],
  ...
  halt_on_failure               => q[1],
  histfile                      => q[D:\\proXAMPP\\cpan\\histfile],
  histsize                      => q[1000],
  http_proxy                    => q[],
  inactivity_timeout            => q[0],
  index_expire                  => q[1],
  inhibit_startup_message       => q[0],
  keep_source_where             => q[D:\\proXAMPP\\cpan\\sources],
  load_module_verbosity         => q[none],
  lynx                          => q[],
  make                          => q[D:\\proXAMPP\\c\\bin\\gmake.exe],
  make_arg                      => q[],
  make_install_arg              => q[UNINST=1],
  make_install_make_command     => q[D:\\proXAMPP\\c\\bin\\gmake.exe],
  makepl_arg                    => q[],
  mbuild_arg                    => q[],
  ...
  patch                         => q[D:\\proXAMPP\\c\\bin\\patch.exe],
  perl5lib_verbosity            => q[none],
  prefer_external_tar           => q[0],
  prefer_installer              => q[MB],
  prefs_dir                     => q[D:\\proXAMPP\\cpan\\prefs],

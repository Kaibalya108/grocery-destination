...
--><body>
    ...
    <div id="background">
        ...
        <div id="page">
            <div id="sidebar">
                <a href="user_index.php" class="logo"><img src="images/l2.jpg" alt=""></a>
                <ul>
                    <li>
                        <span><a href="user_index.php"><i class="icon-home icon-large"></i>Home</a></span>
                    </li>
                    <li>
                        <span><a href="user_All_Products"><i class=" icon-th-large icon-large"></i>Products</a></span>
                    </li>
                ...
                <div class="hero-unit-table">
                    ...
                    <div id="body">
						...
						<h4>Call  <a href="tel:+918210611264"  </a>   +91-8210611264
							...
							<a href="https://api.whatsapp.com/send?phone=917205827877"><img src="images/whatsapp.gif"  width="80" height="67" alt="AOne  9439364623"></a>
